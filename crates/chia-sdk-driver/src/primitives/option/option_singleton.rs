...
use super::{OptionContract, OptionContractLayers, OptionInfo, OptionMetadata};

#[derive(Debug, Clone, Copy)]
pub struct OptionSingleton {
    pub coin: Coin,
    pub proof: Proof,
    pub info: OptionInfo,
}

impl OptionSingleton {
    ...
    ) -> Result<OptionSingleton, DriverError>
    where
        I: SpendWithConditions,
    {
