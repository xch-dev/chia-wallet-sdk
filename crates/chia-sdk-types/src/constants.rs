...
pub static TESTNET11_CONSTANTS: Lazy<ConsensusConstants> = Lazy::new(|| ConsensusConstants {
    ...
    max_future_time2: 120,
    number_of_timestamps: 11,
    genesis_challenge: TESTNET11_GENESIS_CHALLENGE,
    agg_sig_me_additional_data: TESTNET11_GENESIS_CHALLENGE,
    agg_sig_parent_additional_data: hash(TESTNET11_GENESIS_CHALLENGE, 43),
    agg_sig_puzzle_additional_data: hash(TESTNET11_GENESIS_CHALLENGE, 44),
    agg_sig_amount_additional_data: hash(TESTNET11_GENESIS_CHALLENGE, 45),
    agg_sig_puzzle_amount_additional_data: hash(TESTNET11_GENESIS_CHALLENGE, 46),
    agg_sig_parent_amount_additional_data: hash(TESTNET11_GENESIS_CHALLENGE, 47),
    agg_sig_parent_puzzle_additional_data: hash(TESTNET11_GENESIS_CHALLENGE, 48),
    genesis_pre_farm_pool_puzzle_hash: Bytes32::new(hex!(
