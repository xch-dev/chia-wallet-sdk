...
mod tests {
    ...
    fn test_parse_nft() -> anyhow::Result<()> {
        ...
        // let (mint_nft, nft, _) = Launcher::new(did_info.coin.coin_id(), 1).mint_nft(
        //     &mut ctx,
        //     NftMint {
        //         metadata: (),
        ...
        // let nft_puzzle =
        //     NftPuzzle::parse(&allocator, singleton.launcher_id, &singleton.inner_puzzle)?
        //         .expect("not an nft puzzle");

        // let parsed_nft_info = nft_puzzle.child_coin_info(
        //     &mut allocator,
        //     &singleton,
        //     coin_spend.coin,
        //     nft.coin,
        ...
        // assert_eq!(
        //     parsed_nft_info,
        //     nft.with_metadata(NodePtr::NIL, ().tree_hash())
        // );
