...
//
// napi multi-input SP send + scan-from-tweaks E2E.
//
// Exercises the napi multi-input flow with full FFI fidelity:
...
test("napi: multi-input SP send -> tweak_data_from_block_spends -> scan", (t) => {
