...
export declare function enforceDelegatedPuzzleWrappersRestriction(wrapperHashes: Array<Uint8Array>): Restriction
export declare function force1Of2WrapperHash(leftSideSubtreeHash: Uint8Array, nonce: number, memberValidatorListHash: Uint8Array, delegatedPuzzleValidatorListHash: Uint8Array): Uint8Array
export declare function preventConditionOpcodeWrapperHash(conditionOpcode: number): Uint8Array
export declare function preventMultipleCreateCoinsWrapperHash(): Uint8Array
...
export declare class ClvmAllocator {
  ...
  wrapWithForce1Of2(spend: Spend, leftSideSubtreeHash: Uint8Array, nonce: number, memberValidatorListHash: Uint8Array, delegatedPuzzleValidatorListHash: Uint8Array, newRightSideMemberHash: Uint8Array): Spend
  wrapWithPreventConditionOpcode(spend: Spend, conditionOpcode: number): Spend
  wrapWithPreventMultipleCreateCoins(spend: Spend): Spend
...
export declare class MipsSpend {
  ...
  spendEnforceDelegatedPuzzleWrappersRestriction(clvm: ClvmAllocator, wrapperHashes: Array<Uint8Array>, innerDelegatedPuzzleHash: Uint8Array): void
}
