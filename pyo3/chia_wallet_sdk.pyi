...
class Clvm:
    ...
    def reward_distributor_from_eve_coin_spend(self, constants: RewardDistributorConstants, initialState: RewardDistributorState, eveCoinSpend: CoinSpend, reserveParentId: bytes, reserveLineageProof: LineageProof) -> Optional[RewardDistributor]: ...
