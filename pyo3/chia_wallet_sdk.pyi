...
class RpcClientOptions:
    def clone(self) -> RpcClientOptions: ...
    def __init__(self, timeoutMs: Optional[int] = None, connectTimeoutMs: Optional[int] = None) -> None: ...
...
class RpcClient:
    ...
    @staticmethod
    def new_with_options(coinsetUrl: str, options: RpcClientOptions) -> RpcClient: ...
    @staticmethod
    def testnet11() -> RpcClient: ...
    @staticmethod
    def testnet11_with_options(options: RpcClientOptions) -> RpcClient: ...
    @staticmethod
    def mainnet() -> RpcClient: ...
    @staticmethod
    def mainnet_with_options(options: RpcClientOptions) -> RpcClient: ...
    @staticmethod
    def local(certBytes: bytes, keyBytes: bytes) -> RpcClient: ...
    @staticmethod
    def local_with_options(certBytes: bytes, keyBytes: bytes, options: RpcClientOptions) -> RpcClient: ...
    @staticmethod
    def local_with_url(baseUrl: str, certBytes: bytes, keyBytes: bytes) -> RpcClient: ...
    @staticmethod
    def local_with_url_and_options(baseUrl: str, certBytes: bytes, keyBytes: bytes, options: RpcClientOptions) -> RpcClient: ...
