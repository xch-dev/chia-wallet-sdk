...
class Clvm:
    ...
    def medieval_vault_send_message_delegated_puzzle(self, messagePrefix: int, message: bytes, receiverLauncherId: bytes, myCoin: Coin, myInfo: MedievalVaultInfo, genesisChallenge: bytes) -> Program: ...
...
class XchandlesRegistry:
    ...
    def execute_update(self, handleSlot: XchandlesHandleSlot, updateSlot: XchandlesUpdateSlot, newOwnerLauncherId: bytes, newResolvedLauncherId: bytes, currentOwner: CompactCoinProof, minExecutionHeight: int, newOwnerInnerPuzzleHash: bytes, newResolvedInnerPuzzleHash: bytes) -> XchandlesExecuteUpdateResult: ...
