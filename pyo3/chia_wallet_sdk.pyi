...
def singleton_struct_hash(launcher_id: bytes) -> bytes: ...
def xchandles_register_owner_message(precommit_puzzle_hash: bytes) -> bytes: ...
def xchandles_expire_owner_message(precommit_puzzle_hash: bytes) -> bytes: ...
def predict_blank_handle_nft_coin_id(launcher_id: bytes, synthetic_public_key: PublicKey, royalty_puzzle_hash: bytes, royalty_basis_points: int) -> bytes: ...
def xchandles_registration_delegated_puzzle_hash(registry_launcher_id: bytes, precommit_puzzle_hash: bytes, p2_puzzle_hash: bytes, registration_timestamp: int, current_expiration: int, final_handle_nft_metadata: HandleNftMetadata) -> bytes: ...
...
class XchandlesRegistry:
    ...
    def refund(self, precommitCoin: XchandlesPrecommitCoin, pricingPuzzleReveal: Program, pricingPuzzleSolution: Program, slot: Optional[XchandlesHandleSlot] = None) -> List[Program]: ...
