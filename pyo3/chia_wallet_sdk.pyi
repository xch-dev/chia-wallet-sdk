...
class RewardDistributor:
    ...
    def refresh_nfts(self, slots: List[EntrySlot], nfts: List[List[Nft]], nftSharesDelta: List[List[i64]], nftNewShares: List[List[int]], nftInclusionProofs: List[List[MerkleProof]], dlRootHash: bytes, dlMetadataRestHash: Optional[bytes], dlMetadataUpdaterHashHash: bytes, dlInnerPuzzleHash: bytes) -> RewardDistributorRefreshNftsResult: ...
    @staticmethod
