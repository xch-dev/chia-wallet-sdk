...
class RefreshNftsInfo:
    ...
    def __init__(self, slot: EntrySlot, nfts: List[Nft], nftSharesDelta: List[int], newShares: List[int], nftInclusionProofs: List[MerkleProof]) -> None: ...
    slot: EntrySlot
    nfts: List[Nft]
...
class RewardDistributor:
    ...
    def unstake_locked_nfts(self, entrySlot: EntrySlot, lockedNfts: List[Nft], lockedNftShares: List[int]) -> RewardDistributorUnstakeLockedNftsResult: ...
    def unstake_locked_cat(self, entrySlot: EntrySlot, lockedCat: Cat) -> RewardDistributorUnstakeLockedCatResult: ...
