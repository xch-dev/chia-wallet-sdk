...
def force_singleton_recreation_restriction() -> Restriction: ...
...
def xchandles_get_price(basePrice: int, handle: str, numPeriods: int) -> int: ...
def singleton_struct_hash(launcherId: bytes) -> bytes: ...
def xchandles_register_owner_message(precommitPuzzleHash: bytes) -> bytes: ...
def xchandles_expire_owner_message(precommitPuzzleHash: bytes) -> bytes: ...
def predict_blank_handle_nft_coin_id(launcherId: bytes, syntheticPublicKey: PublicKey, royaltyPuzzleHash: bytes, royaltyBasisPoints: int) -> bytes: ...
def xchandles_registration_delegated_puzzle_hash(registryLauncherId: bytes, precommitPuzzleHash: bytes, p2PuzzleHash: bytes, registrationTimestamp: int, currentExpiration: int, finalHandleNftMetadata: HandleNftMetadata) -> bytes: ...
...
class Signature:
    ...
    def is_infinity(self) -> bool: ...
    def is_valid(self) -> bool: ...
class SlotNeigborsInfo:
    def clone(self) -> SlotNeigborsInfo: ...
    def __init__(self, leftValue: bytes, rightValue: bytes) -> None: ...
    left_value: bytes
    right_value: bytes
class CatalogSlotValue:
    def clone(self) -> CatalogSlotValue: ...
    counter: int
    asset_id: bytes
    neighbors: SlotNeigborsInfo
    @staticmethod
    def new(counter: int, assetId: bytes, leftAssetId: bytes, rightAssetId: bytes) -> CatalogSlotValue: ...
    def value_hash(self) -> bytes: ...
class CatalogSlot:
    def clone(self) -> CatalogSlot: ...
    coin: Coin
    proof: LineageProof
    nonce: int
    launcher_id: bytes
    ...
    @staticmethod
    def new(proof: LineageProof, launcherId: bytes, value: CatalogSlotValue) -> CatalogSlot: ...
    def value_hash(self) -> bytes: ...
class CatalogRegistryState:
    def clone(self) -> CatalogRegistryState: ...
    def __init__(self, catMakerPuzzleHash: bytes, registrationPrice: int) -> None: ...
    cat_maker_puzzle_hash: bytes
    registration_price: int
class CatalogRegisterActionLog:
    def clone(self) -> CatalogRegisterActionLog: ...
    spent_left_slot: CatalogSlotValue
    spent_right_slot: CatalogSlotValue
    created_left_slot: CatalogSlotValue
    created_tail_slot: CatalogSlotValue
    created_right_slot: CatalogSlotValue
    prelauncher_full_puzzle_hash: bytes
    prelauncher_id: bytes
    launcher_id: bytes
    registered_tail_hash: bytes
    registered_initial_inner_puzzle_hash: bytes
    precommit_amount: int
class CatalogRefundActionLog:
    def clone(self) -> CatalogRefundActionLog: ...
    spent_slot: Optional[CatalogSlotValue]
    created_slot: Optional[CatalogSlotValue]
    registered_tail_hash: bytes
    registered_initial_inner_puzzle_hash: bytes
    precommit_amount: int
class CatalogDelegatedStateActionLog:
    def clone(self) -> CatalogDelegatedStateActionLog: ...
    old_state: CatalogRegistryState
    new_state: CatalogRegistryState
class CatalogActionLog:
    def clone(self) -> CatalogActionLog: ...
    kind: str
    register: Optional[CatalogRegisterActionLog]
    refund: Optional[CatalogRefundActionLog]
    delegated_state: Optional[CatalogDelegatedStateActionLog]
class CatalogRegistryConstants:
    def clone(self) -> CatalogRegistryConstants: ...
    launcher_id: bytes
    royalty_address: bytes
    royalty_basis_points: int
    precommit_payout_puzzle_hash: bytes
    relative_block_height: int
    price_singleton_launcher_id: bytes
    @staticmethod
    def get(testnet11: bool) -> CatalogRegistryConstants: ...
    def with_price_singleton(self, priceSingletonLauncherId: bytes) -> CatalogRegistryConstants: ...
    def with_launcher_id(self, launcherId: bytes) -> CatalogRegistryConstants: ...
class CatalogPrecommitValue:
    def clone(self) -> CatalogPrecommitValue: ...
    tail_reveal: Program
    initial_inner_puzzle_hash: bytes
    payment_asset_id: bytes
    @staticmethod
    def with_default_cat_maker(clvm: Clvm, paymentAssetId: bytes, initialInnerPuzzleHash: bytes, tailReveal: Program) -> CatalogPrecommitValue: ...
class CatalogPrecommitCoin:
    def clone(self) -> CatalogPrecommitCoin: ...
    coin: Coin
    asset_id: bytes
    proof: LineageProof
    ...
    @staticmethod
    def new(clvm: Clvm, parentCoinId: bytes, proof: LineageProof, assetId: bytes, controllerSingletonLauncherId: bytes, relativeBlockHeight: int, payoutPuzzleHash: bytes, refundPuzzleHash: bytes, value: CatalogPrecommitValue, precommitAmount: int) -> CatalogPrecommitCoin: ...
class CatalogRegistryFinishedSpendResult:
    def clone(self) -> CatalogRegistryFinishedSpendResult: ...
    def __init__(self, newCatalog: CatalogRegistry, signature: Signature) -> None: ...
    new_catalog: CatalogRegistry
    signature: Signature
class CatalogRegistryLaunchResult:
    def clone(self) -> CatalogRegistryLaunchResult: ...
    def __init__(self, securitySignature: Signature, securitySecretKey: SecretKey, catalog: CatalogRegistry, slots: List[CatalogSlot], securityCoin: Coin) -> None: ...
...
class CatalogRegistry:
    def clone(self) -> CatalogRegistry: ...
    def coin(self) -> Coin: ...
    def proof(self) -> Proof: ...
    def state(self) -> CatalogRegistryState: ...
    def constants(self) -> CatalogRegistryConstants: ...
    def inner_puzzle_hash(self) -> bytes: ...
    def puzzle_hash(self) -> bytes: ...
    def child(self) -> CatalogRegistry: ...
    def pending_created_slots(self) -> List[CatalogSlot]: ...
    def pending_spent_slots(self) -> List[CatalogSlotValue]: ...
    def pending_logs(self) -> List[CatalogActionLog]: ...
    def pending_signature(self) -> Signature: ...
    def finish_spend(self) -> CatalogRegistryFinishedSpendResult: ...
    def register(self, tailHash: bytes, leftSlot: CatalogSlot, rightSlot: CatalogSlot, precommitCoin: CatalogPrecommitCoin, eveNftInnerSpend: Spend) -> List[Program]: ...
    def refund(self, tailHash: bytes, precommitCoin: CatalogPrecommitCoin, neighbors: Optional[SlotNeigborsInfo] = None, slot: Optional[CatalogSlot] = None) -> List[Program]: ...
    def delegated_state(self, newState: CatalogRegistryState, otherSingletonInnerPuzzleHash: bytes) -> List[Program]: ...
    def actual_neighbors(self, newTailHash: bytes, onChainLeftSlot: CatalogSlot, onChainRightSlot: CatalogSlot) -> CatalogRegistryActualNeighborsResult: ...
    def actual_slot(self, slot: CatalogSlot) -> CatalogSlot: ...
class CatalogRegistryActualNeighborsResult:
    def clone(self) -> CatalogRegistryActualNeighborsResult: ...
    def __init__(self, leftSlot: CatalogSlot, rightSlot: CatalogSlot) -> None: ...
...
class Clvm:
    ...
    def spend_p2_next_reward_distributor_epoch(self, cat: Cat, info: P2NextRewardDistributorEpochCoinInfo, nextEpochStart: int, rewardDistributorInnerPuzzleHash: bytes) -> CatSpend: ...
    def mint_nfts(self, parentCoinId: bytes, nftMints: List[NftMint]) -> MintedNfts: ...
    def spend_nft(self, nft: Nft, innerSpend: Spend) -> Nft: ...
    def mint_datastore(self, parentCoinId: bytes, metadata: DatastoreMetadata, ownerPuzzleHash: bytes, delegatedPuzzles: List[DelegatedPuzzle]) -> MintedDatastore: ...
    def datastore_from_spend(self, parentSpend: CoinSpend, delegatedPuzzles: Optional[List[DelegatedPuzzle]] = None) -> Optional[Datastore]: ...
    ...
    def handle_nft_metadata(self, value: HandleNftMetadata) -> Program: ...
    ...
    def update_datastore_merkle_root(self, newMerkleRoot: bytes, memos: List[bytes]) -> Program: ...
    ...
    def medieval_vault_send_message_delegated_puzzle(self, prefixAndMessage: bytes, receiverLauncherId: bytes, myCoin: Coin, myInfo: MedievalVaultInfo, genesisChallenge: bytes) -> Program: ...
    ...
    def reward_distributor_from_mempool_item(self, mempoolItem: SpendBundle, constants: RewardDistributorConstants) -> Optional[RewardDistributor]: ...
    def catalog_registry_from_spend(self, spend: CoinSpend, constants: CatalogRegistryConstants) -> Optional[CatalogRegistry]: ...
    def catalog_registry_from_parent_spend(self, parentSpend: CoinSpend, constants: CatalogRegistryConstants) -> Optional[CatalogRegistry]: ...
    def catalog_registry_from_mempool_item(self, mempoolItem: SpendBundle, constants: CatalogRegistryConstants) -> Optional[CatalogRegistry]: ...
    def launch_catalog_registry(self, offer: SpendBundle, initialRegistrationPrice: int, constants: CatalogRegistryConstants, initialRegistrationAssetId: bytes, mainnet: bool) -> CatalogRegistryLaunchResult: ...
    def xchandles_registry_from_spend(self, spend: CoinSpend, constants: XchandlesConstants) -> Optional[XchandlesRegistry]: ...
    def xchandles_registry_from_parent_spend(self, parentSpend: CoinSpend, constants: XchandlesConstants) -> Optional[XchandlesRegistry]: ...
    def xchandles_registry_from_mempool_item(self, mempoolItem: SpendBundle, constants: XchandlesConstants) -> Optional[XchandlesRegistry]: ...
    def launch_xchandles_registry(self, offer: SpendBundle, initialBaseRegistrationPrice: int, initialRegistrationPeriod: int, constants: XchandlesConstants, initialRegistrationAssetId: bytes, mainnet: bool) -> XchandlesRegistryLaunchResult: ...
    def create_offer_security_coin(self, offer: SpendBundle) -> OfferSecurityCoinDetails: ...
    def create_security_coin_with_pk(self, xchSettlementCoin: Coin, publicKey: PublicKey) -> Coin: ...
    def create_offer_security_coin_with_key(self, offer: SpendBundle, securityCoinSk: SecretKey) -> OfferSecurityCoinDetails: ...
    ...
    def spend_settlement_cats(self, offer: SpendBundle, assetId: bytes, nonce: bytes, payments: List[Payment]) -> SpendSettlementCatsResult: ...
    def state_scheduler_layer(self, receiverSingletonStructHash: bytes, prefixAndMessage: bytes, innerPuzzle: Program) -> Program: ...
    ...
    def force_singleton_recreation(self) -> Program: ...
    ...
    def any_metadata_updater(self) -> Program: ...
    def state_scheduler_puzzle(self) -> Program: ...
class Output:
...
class SpendSettlementCatsResult:
    def clone(self) -> SpendSettlementCatsResult: ...
    def __init__(self, createdCats: List[Cat], securityConditions: List[Program]) -> None: ...
...
class Constants:
    ...
    @staticmethod
    def force_singleton_recreation() -> bytes: ...
    @staticmethod
    def force_singleton_recreation_hash() -> bytes: ...
    @staticmethod
    ...
    @staticmethod
    def any_metadata_updater() -> bytes: ...
    @staticmethod
    def any_metadata_updater_hash() -> bytes: ...
    @staticmethod
    def state_scheduler_puzzle() -> bytes: ...
    @staticmethod
    def state_scheduler_puzzle_hash() -> bytes: ...
class FullNodeSimulator:
    def clone(self) -> FullNodeSimulator: ...
    def __init__(self) -> None: ...
    @staticmethod
    def with_seed(seed: int) -> FullNodeSimulator: ...
    @staticmethod
    def with_secret_key(secretKey: SecretKey) -> FullNodeSimulator: ...
    def height(self) -> int: ...
    ...
    def get_farming_ph(self) -> bytes: ...
    def get_master_secret_key(self) -> SecretKey: ...
    def get_prefarm_puzzle_hash(self) -> bytes: ...
    def set_farming_ph(self, puzzleHash: bytes) -> None: ...
    def get_blockchain_state(self) -> BlockchainStateResponse: ...
    def get_network_info(self) -> GetNetworkInfoResponse: ...
    def get_aggsig_additional_data(self) -> bytes: ...
    def get_block_record(self, headerHash: bytes) -> GetBlockRecordResponse: ...
    def get_block_record_by_height(self, height: int) -> GetBlockRecordResponse: ...
    def get_block_records(self, start: int, end: int) -> GetBlockRecordsResponse: ...
    def get_additions_and_removals(self, headerHash: bytes) -> AdditionsAndRemovalsResponse: ...
    def get_block_spends(self, headerHash: bytes) -> GetBlockSpendsResponse: ...
    def get_coin_record_by_name(self, name: bytes) -> GetCoinRecordResponse: ...
    ...
    def get_coin_records_by_parent_ids(self, parentIds: List[bytes], startHeight: Optional[int] = None, endHeight: Optional[int] = None, includeSpentCoins: Optional[bool] = None) -> GetCoinRecordsResponse: ...
    ...
    def get_puzzle_and_solution(self, coinId: bytes, height: Optional[int] = None) -> GetPuzzleAndSolutionResponse: ...
    def push_tx(self, spendBundle: SpendBundle) -> PushTxResponse: ...
    def get_mempool_item_by_tx_id(self, txId: bytes) -> GetMempoolItemResponse: ...
    def get_mempool_items_by_coin_name(self, coinName: bytes) -> GetMempoolItemsResponse: ...
    def farm_block(self, blocks: int) -> List[BlockRecord]: ...
    def revert_blocks(self, blocks: int) -> List[bytes]: ...
    def reorg_blocks(self, numOfBlocksToRev: int, numOfNewBlocks: int) -> List[BlockRecord]: ...
    def drain_events(self) -> List[FullNodeSimulatorEvent]: ...
    def dump_state(self) -> str: ...
    def restore_state(self, state: str) -> None: ...
    async def start_server(self) -> Awaitable[FullNodeSimulatorServer]: ...
class FullNodeSimulatorEvent:
    def clone(self) -> FullNodeSimulatorEvent: ...
    def block(self) -> Optional[FullNodeSimulatorBlockEvent]: ...
    def reorg(self) -> Optional[FullNodeSimulatorReorgEvent]: ...
class FullNodeSimulatorBlockEvent:
    def clone(self) -> FullNodeSimulatorBlockEvent: ...
    height: int
    header_hash: bytes
    previous_header_hash: bytes
    additions: List[CoinRecord]
    removals: List[CoinRecord]
class FullNodeSimulatorReorgEvent:
    def clone(self) -> FullNodeSimulatorReorgEvent: ...
    fork_height: int
    old_peak_hash: bytes
    new_peak_hash: bytes
    reverted_header_hashes: List[bytes]
    new_header_hashes: List[bytes]
class FullNodeSimulatorServer:
    def clone(self) -> FullNodeSimulatorServer: ...
    url: str
    def close(self) -> None: ...
class MerkleProof:
    def clone(self) -> MerkleProof: ...
    def __init__(self, path: int, proof: List[bytes]) -> None: ...
    path: int
    proof: List[bytes]
class Vault:
...
class MipsSpend:
    ...
    def force_singleton_recreation(self) -> None: ...
...
class WrapperMemo:
    ...
    @staticmethod
    def force_singleton_recreation(clvm: Clvm) -> WrapperMemo: ...
    @staticmethod
...
class Program:
    ...
    def parse_handle_nft_metadata(self) -> Optional[HandleNftMetadata]: ...
    ...
    def parse_update_datastore_merkle_root(self) -> Optional[UpdateDatastoreMerkleRoot]: ...
...
class HandleNftMetadata:
    def clone(self) -> HandleNftMetadata: ...
    def __init__(self, displayName: Optional[str], imageUris: List[str], imageHash: Optional[bytes], metadataUris: List[str], metadataHash: Optional[bytes], licenseUris: List[str], licenseHash: Optional[bytes] = None) -> None: ...
...
class P2ParentCoinChildParseResult:
    ...
    memos: List[bytes]
class P2NextRewardDistributorEpochCoinInfo:
    def clone(self) -> P2NextRewardDistributorEpochCoinInfo: ...
    clawback_inner_puzzle_hash: bytes
    reward_asset_id: bytes
    reward_distributor_launcher_id: bytes
    reward_distributor_first_epoch_start: int
    reward_distributor_epoch_seconds: int
    def __init__(self, clawbackInnerPuzzleHash: bytes, rewardAssetId: bytes, rewardDistributorLauncherId: bytes, rewardDistributorFirstEpochStart: int, rewardDistributorEpochSeconds: int) -> None: ...
    @staticmethod
    def from_constants(constants: RewardDistributorConstants, rewardDistributorFirstEpochStart: int, clawbackInnerPuzzleHash: bytes) -> P2NextRewardDistributorEpochCoinInfo: ...
    def clawback_puzzle_hash(self, coinId: bytes) -> bytes: ...
    def inner_puzzle_hash(self) -> bytes: ...
    def puzzle_hash(self) -> bytes: ...
class CuratedDatastoreFields:
    def clone(self) -> CuratedDatastoreFields: ...
    def __init__(self, rootHash: bytes, metadataRestHash: Optional[bytes], metadataUpdaterHashHash: bytes, innerPuzzleHash: bytes) -> None: ...
    root_hash: bytes
    metadata_rest_hash: Optional[bytes]
    metadata_updater_hash_hash: bytes
    inner_puzzle_hash: bytes
class DatastoreMetadata:
    def clone(self) -> DatastoreMetadata: ...
    def __init__(self, rootHash: bytes, label: Optional[str] = None, description: Optional[str] = None, bytes: Optional[int] = None, sizeProof: Optional[str] = None) -> None: ...
    root_hash: bytes
    label: Optional[str]
    description: Optional[str]
    bytes: Optional[int]
    size_proof: Optional[str]
class DelegatedPuzzleOracle:
    def clone(self) -> DelegatedPuzzleOracle: ...
    def __init__(self, oraclePuzzleHash: bytes, oracleFee: int) -> None: ...
    oracle_puzzle_hash: bytes
    oracle_fee: int
class DelegatedPuzzle:
    def clone(self) -> DelegatedPuzzle: ...
    @staticmethod
    def oracle(oraclePuzzleHash: bytes, oracleFee: int) -> DelegatedPuzzle: ...
    @staticmethod
    def admin(puzzleHash: bytes) -> DelegatedPuzzle: ...
    @staticmethod
    def writer(innerPuzzleHash: bytes) -> DelegatedPuzzle: ...
    @staticmethod
    def admin_from_key(syntheticKey: PublicKey) -> DelegatedPuzzle: ...
    @staticmethod
    def writer_from_key(syntheticKey: PublicKey) -> DelegatedPuzzle: ...
    def to_admin(self) -> Optional[bytes]: ...
    def to_writer(self) -> Optional[bytes]: ...
    def to_oracle(self) -> Optional[DelegatedPuzzleOracle]: ...
class MintedDatastore:
    def clone(self) -> MintedDatastore: ...
    def __init__(self, datastore: Datastore, parentConditions: List[Program]) -> None: ...
    datastore: Datastore
    parent_conditions: List[Program]
class Datastore:
    ...
    def coin(self) -> Coin: ...
    def proof(self) -> Proof: ...
    def launcher_id(self) -> bytes: ...
    def owner_puzzle_hash(self) -> bytes: ...
    def metadata(self) -> DatastoreMetadata: ...
    def root_hash(self) -> bytes: ...
    def label(self) -> Optional[str]: ...
    def description(self) -> Optional[str]: ...
    def bytes(self) -> Optional[int]: ...
    def size_proof(self) -> Optional[str]: ...
    def delegated_puzzles(self) -> List[DelegatedPuzzle]: ...
    def curated_fields(self) -> CuratedDatastoreFields: ...
    def owner_create_coin_condition(self, newOwnerPuzzleHash: bytes, newDelegatedPuzzles: List[DelegatedPuzzle], hintDelegatedPuzzles: bool) -> Program: ...
    def new_metadata_condition(self, newMetadata: DatastoreMetadata) -> Program: ...
    def spend(self, innerSpend: Spend) -> Datastore: ...
    def spend_oracle(self) -> None: ...
    def update_metadata_as_owner(self, ownerSyntheticKey: PublicKey, newMetadata: DatastoreMetadata) -> Datastore: ...
    def update_ownership(self, newOwnerPuzzleHash: bytes, newDelegatedPuzzles: List[DelegatedPuzzle], ownerSyntheticKey: Optional[PublicKey] = None, adminSyntheticKey: Optional[PublicKey] = None) -> Datastore: ...
class RewardDistributorType:
    def clone(self) -> RewardDistributorType: ...
    @staticmethod
    def managed(managerSingletonLauncherId: bytes) -> RewardDistributorType: ...
    @staticmethod
    def nft_collection(collectionDidLauncherId: bytes) -> RewardDistributorType: ...
    @staticmethod
    def curated_nft(storeLauncherId: bytes, refreshable: bool) -> RewardDistributorType: ...
    @staticmethod
    def cat(assetId: bytes, hiddenPuzzleHash: Optional[bytes] = None) -> RewardDistributorType: ...
class RewardDistributorConstants:
    ...
    @staticmethod
    def without_launcher_id(rewardDistributorType: RewardDistributorType, feePayoutPuzzleHash: bytes, epochSeconds: int, precision: int, maxSecondsOffset: int, payoutThreshold: int, requirePayoutApproval: bool, feeBps: int, withdrawalShareBps: int, reserveAssetId: bytes) -> RewardDistributorConstants: ...
    def with_launcher_id(self, launcherId: bytes) -> RewardDistributorConstants: ...
    def reward_distributor_type(self) -> RewardDistributorType: ...
...
class RewardDistributorRefreshNftsFromDlActionLog:
    ...
    spent_deposit_slots: List[RewardDistributorDepositSlotValue]
    created_deposit_slots: List[RewardDistributorDepositSlotValue]
    nft_entries: List[RewardDistributorNftStakeEntry]
    dl_root_hash: bytes
...
class RewardDistributorRewardSlotValue:
    ...
    def __init__(self, counter: int, epochStart: int, nextEpochInitialized: bool, rewards: int) -> None: ...
    counter: int
    epoch_start: int
...
class RewardDistributorEntrySlotValue:
    ...
    def __init__(self, counter: int, payoutPuzzleHash: bytes, initialCumulativePayout: int, shares: int) -> None: ...
    counter: int
...
class EntrySlot:
    ...
    def value_hash(self) -> bytes: ...
class RewardDistributorDepositSlotValue:
    def clone(self) -> RewardDistributorDepositSlotValue: ...
    payout_puzzle_hash: bytes
    shares: int
    @staticmethod
    def nft(payoutPuzzleHash: bytes, shares: int, launcherId: bytes) -> RewardDistributorDepositSlotValue: ...
    @staticmethod
    def cat(payoutPuzzleHash: bytes, catAmount: int) -> RewardDistributorDepositSlotValue: ...
    def launcher_id(self) -> Optional[bytes]: ...
    def cat_amount(self) -> Optional[int]: ...
class DepositSlot:
    def clone(self) -> DepositSlot: ...
    coin: Coin
    proof: LineageProof
    nonce: int
    launcher_id: bytes
    value: RewardDistributorDepositSlotValue
    @staticmethod
    def new(proof: LineageProof, launcherId: bytes, value: RewardDistributorDepositSlotValue) -> DepositSlot: ...
    def value_hash(self) -> bytes: ...
...
class IntermediaryCoinProof:
    ...
    amount: int
class CompactLineageProof:
    def clone(self) -> CompactLineageProof: ...
    def __init__(self, parentParentCoinInfo: bytes, parentInnerPuzzleHash: bytes, parentAmount: int) -> None: ...
    parent_parent_coin_info: bytes
    parent_inner_puzzle_hash: bytes
    parent_amount: int
    @staticmethod
    def from_lineage_proof(proof: LineageProof) -> CompactLineageProof: ...
class NftLauncherProof:
    def clone(self) -> NftLauncherProof: ...
    def __init__(self, didProof: CompactLineageProof, intermediaryCoinProofs: List[IntermediaryCoinProof]) -> None: ...
    did_proof: CompactLineageProof
    intermediary_coin_proofs: List[IntermediaryCoinProof]
class RewardDistributorStakeCollectionNftsResult:
    def clone(self) -> RewardDistributorStakeCollectionNftsResult: ...
    conditions: List[Program]
    notarized_payments: List[NotarizedPayment]
    new_nfts: List[Nft]
class RewardDistributorStakeCuratedNftsResult:
    def clone(self) -> RewardDistributorStakeCuratedNftsResult: ...
    conditions: List[Program]
    notarized_payments: List[NotarizedPayment]
    new_nfts: List[Nft]
class RewardDistributorStakeCatResult:
    def clone(self) -> RewardDistributorStakeCatResult: ...
    conditions: List[Program]
    notarized_payment: NotarizedPayment
    new_cat: Cat
class RewardDistributorUnstakeLockedNftsResult:
    def clone(self) -> RewardDistributorUnstakeLockedNftsResult: ...
    conditions: List[Program]
    payment_amount: int
class RewardDistributorUnstakeLockedCatResult:
    def clone(self) -> RewardDistributorUnstakeLockedCatResult: ...
    conditions: List[Program]
    payment_amount: int
class RewardDistributorRefreshNftsResult:
    def clone(self) -> RewardDistributorRefreshNftsResult: ...
    conditions: List[Program]
    new_nfts: List[Nft]
class RefreshNftsInfo:
    def clone(self) -> RefreshNftsInfo: ...
    def __init__(self, slot: EntrySlot, nfts: List[Nft], nftSharesDelta: List[int], newShares: List[int], nftInclusionProofs: List[MerkleProof], depositSlots: List[DepositSlot]) -> None: ...
    slot: EntrySlot
    nfts: List[Nft]
    nft_shares_delta: List[int]
    new_shares: List[int]
    nft_inclusion_proofs: List[MerkleProof]
...
class RewardDistributor:
    ...
    def pending_created_deposit_slots(self) -> List[DepositSlot]: ...
    ...
    def stake_collection_nfts(self, offeredNfts: List[Nft], nftLauncherProofs: List[NftLauncherProof], entryCustodyPuzzleHash: bytes, existingSlot: Optional[EntrySlot] = None) -> RewardDistributorStakeCollectionNftsResult: ...
    def stake_curated_nfts(self, offeredNfts: List[Nft], nftShares: List[int], inclusionProofs: List[MerkleProof], entryCustodyPuzzleHash: bytes, existingSlot: Optional[EntrySlot], dlRootHash: bytes, dlMetadataRestHash: Optional[bytes], dlMetadataUpdaterHashHash: bytes, dlInnerPuzzleHash: bytes) -> RewardDistributorStakeCuratedNftsResult: ...
    def stake_cat(self, offeredCat: Cat, entryCustodyPuzzleHash: bytes, existingSlot: Optional[EntrySlot] = None) -> RewardDistributorStakeCatResult: ...
    def unstake_locked_nfts(self, entrySlot: EntrySlot, lockedNfts: List[Nft], lockedNftShares: List[int], depositSlots: List[DepositSlot]) -> RewardDistributorUnstakeLockedNftsResult: ...
    def unstake_locked_cat(self, entrySlot: EntrySlot, lockedCat: Cat, depositSlot: DepositSlot) -> RewardDistributorUnstakeLockedCatResult: ...
    def refresh_nfts(self, refreshNftsInfos: List[RefreshNftsInfo], dlRootHash: bytes, dlMetadataRestHash: Optional[bytes], dlMetadataUpdaterHashHash: bytes, dlInnerPuzzleHash: bytes) -> RewardDistributorRefreshNftsResult: ...
    @staticmethod
...
class CompactCoinProof:
    def clone(self) -> CompactCoinProof: ...
    def __init__(self, parentCoinInfo: bytes, innerPuzzleHash: bytes, amount: int) -> None: ...
    parent_coin_info: bytes
    inner_puzzle_hash: bytes
    amount: int
class XchandlesRegistryState:
    def clone(self) -> XchandlesRegistryState: ...
    cat_maker_puzzle_hash: bytes
    pricing_puzzle_hash: bytes
    expired_handle_pricing_puzzle_hash: bytes
    @staticmethod
    def from(paymentCatTailHashHash: bytes, basePrice: int, registrationPeriod: int) -> XchandlesRegistryState: ...
class XchandlesConstants:
    def clone(self) -> XchandlesConstants: ...
    launcher_id: bytes
    precommit_payout_puzzle_hash: bytes
    relative_block_height: int
    price_singleton_launcher_id: bytes
    @staticmethod
    def new(launcherId: bytes, precommitPayoutPuzzleHash: bytes, relativeBlockHeight: int, priceSingletonLauncherId: bytes) -> XchandlesConstants: ...
    def with_price_singleton(self, priceSingletonLauncherId: bytes) -> XchandlesConstants: ...
    def with_launcher_id(self, launcherId: bytes) -> XchandlesConstants: ...
class XchandlesHandleSlotValue:
    def clone(self) -> XchandlesHandleSlotValue: ...
    counter: int
    handle_hash: bytes
    neighbors: SlotNeigborsInfo
    expiration: int
    owner_launcher_id: bytes
    resolved_launcher_id: bytes
    @staticmethod
    def new(counter: int, handleHash: bytes, leftHandleHash: bytes, rightHandleHash: bytes, expiration: int, ownerLauncherId: bytes, resolvedLauncherId: bytes) -> XchandlesHandleSlotValue: ...
    def value_hash(self) -> bytes: ...
class XchandlesUpdateSlotValue:
    def clone(self) -> XchandlesUpdateSlotValue: ...
    update_initiator_coin_id: bytes
    min_height: int
    handle_hash: bytes
    new_owner_launcher_id: bytes
    new_resolved_launcher_id: bytes
    @staticmethod
    def new(updateInitiatorCoinId: bytes, minHeight: int, handleHash: bytes, newOwnerLauncherId: bytes, newResolvedLauncherId: bytes) -> XchandlesUpdateSlotValue: ...
    def value_hash(self) -> bytes: ...
class XchandlesPricingSolution:
    def clone(self) -> XchandlesPricingSolution: ...
    def __init__(self, buyTime: int, currentExpiration: int, handle: str, numPeriods: int) -> None: ...
    buy_time: int
    current_expiration: int
    handle: str
    num_periods: int
class XchandlesPrecommitValueLog:
    def clone(self) -> XchandlesPrecommitValueLog: ...
    def __init__(self, catMakerHash: bytes, pricingPuzzleHash: bytes, pricingSolution: XchandlesPricingSolution, handle: str, secret: bytes, ownerLauncherId: bytes, resolvedLauncherId: bytes) -> None: ...
    cat_maker_hash: bytes
    pricing_puzzle_hash: bytes
    ...
    owner_launcher_id: bytes
    resolved_launcher_id: bytes
class XchandlesOracleActionLog:
    def clone(self) -> XchandlesOracleActionLog: ...
    spent_slot: XchandlesHandleSlotValue
    created_slot: XchandlesHandleSlotValue
class XchandlesExtendActionLog:
    def clone(self) -> XchandlesExtendActionLog: ...
    spent_slot: XchandlesHandleSlotValue
    created_slot: XchandlesHandleSlotValue
    total_price: int
    registered_time: int
class XchandlesExpireActionLog:
    def clone(self) -> XchandlesExpireActionLog: ...
    spent_slot: XchandlesHandleSlotValue
    created_slot: XchandlesHandleSlotValue
    precommit_value: XchandlesPrecommitValueLog
    total_price: int
    registered_time: int
    owner_full_puzzle_hash: bytes
    resolved_full_puzzle_hash: Optional[bytes]
    owner_inner_puzzle_hash: bytes
    resolved_inner_puzzle_hash: bytes
class XchandlesInitiateUpdateActionLog:
    def clone(self) -> XchandlesInitiateUpdateActionLog: ...
    spent_slot: XchandlesHandleSlotValue
    created_handle_slot: XchandlesHandleSlotValue
    created_update_slot: XchandlesUpdateSlotValue
    initiator_coin_id: bytes
class XchandlesExecuteUpdateActionLog:
    def clone(self) -> XchandlesExecuteUpdateActionLog: ...
    spent_handle_slot: XchandlesHandleSlotValue
    spent_update_slot: XchandlesUpdateSlotValue
    created_slot: XchandlesHandleSlotValue
    owner_coin_id: bytes
    owner_full_puzzle_hash: bytes
    resolved_full_puzzle_hash: Optional[bytes]
    owner_inner_puzzle_hash: bytes
    resolved_inner_puzzle_hash: bytes
class XchandlesRefundActionLog:
    def clone(self) -> XchandlesRefundActionLog: ...
    spent_slot: Optional[XchandlesHandleSlotValue]
    created_slot: Optional[XchandlesHandleSlotValue]
    precommit_value: XchandlesPrecommitValueLog
    precommitted_total_price: int
    precommitted_registered_time: int
class XchandlesRegisterActionLog:
    def clone(self) -> XchandlesRegisterActionLog: ...
    spent_left_slot: XchandlesHandleSlotValue
    spent_right_slot: XchandlesHandleSlotValue
    created_left_slot: XchandlesHandleSlotValue
    created_handle_slot: XchandlesHandleSlotValue
    created_right_slot: XchandlesHandleSlotValue
    precommit_value: XchandlesPrecommitValueLog
    total_price: int
    registered_time: int
    owner_full_puzzle_hash: bytes
    ...
    owner_inner_puzzle_hash: bytes
    resolved_inner_puzzle_hash: bytes
class XchandlesDelegatedStateActionLog:
    def clone(self) -> XchandlesDelegatedStateActionLog: ...
    old_state: XchandlesRegistryState
    new_state: XchandlesRegistryState
class XchandlesActionLog:
    def clone(self) -> XchandlesActionLog: ...
    kind: str
    oracle: Optional[XchandlesOracleActionLog]
    extend: Optional[XchandlesExtendActionLog]
    expire: Optional[XchandlesExpireActionLog]
    initiate_update: Optional[XchandlesInitiateUpdateActionLog]
    execute_update: Optional[XchandlesExecuteUpdateActionLog]
    refund: Optional[XchandlesRefundActionLog]
    register: Optional[XchandlesRegisterActionLog]
    delegated_state: Optional[XchandlesDelegatedStateActionLog]
class XchandlesHandleSlot:
    def clone(self) -> XchandlesHandleSlot: ...
    coin: Coin
    proof: LineageProof
    nonce: int
    launcher_id: bytes
    ...
    @staticmethod
    def new(proof: LineageProof, launcherId: bytes, value: XchandlesHandleSlotValue) -> XchandlesHandleSlot: ...
    def value_hash(self) -> bytes: ...
class XchandlesUpdateSlot:
    def clone(self) -> XchandlesUpdateSlot: ...
    coin: Coin
    proof: LineageProof
    nonce: int
    launcher_id: bytes
    ...
    @staticmethod
    def new(proof: LineageProof, launcherId: bytes, value: XchandlesUpdateSlotValue) -> XchandlesUpdateSlot: ...
    def value_hash(self) -> bytes: ...
class XchandlesPrecommitValue:
    def clone(self) -> XchandlesPrecommitValue: ...
    handle: str
    secret: bytes
    owner_launcher_id: bytes
    resolved_launcher_id: bytes
...
class XchandlesPrecommitCoin:
    ...
    @staticmethod
    def new(clvm: Clvm, parentCoinId: bytes, proof: LineageProof, assetId: bytes, controllerSingletonLauncherId: bytes, relativeBlockHeight: int, payoutPuzzleHash: bytes, refundPuzzleHash: bytes, value: XchandlesPrecommitValue, precommitAmount: int) -> XchandlesPrecommitCoin: ...
    @staticmethod
    def puzzle_hash(assetId: bytes, controllerSingletonLauncherId: bytes, relativeBlockHeight: int, payoutPuzzleHash: bytes, refundPuzzleHash: bytes, value: XchandlesPrecommitValue) -> bytes: ...
class XchandlesRegistryFinishedSpendResult:
    def clone(self) -> XchandlesRegistryFinishedSpendResult: ...
    def __init__(self, newRegistry: XchandlesRegistry, signature: Signature) -> None: ...
    new_registry: XchandlesRegistry
    signature: Signature
class XchandlesRegistryLaunchResult:
    def clone(self) -> XchandlesRegistryLaunchResult: ...
    def __init__(self, securitySignature: Signature, securitySecretKey: SecretKey, registry: XchandlesRegistry, slots: List[XchandlesHandleSlot], securityCoin: Coin) -> None: ...
    security_signature: Signature
    security_secret_key: SecretKey
    registry: XchandlesRegistry
    slots: List[XchandlesHandleSlot]
    security_coin: Coin
class XchandlesRegistryInfoFromLauncher:
    def clone(self) -> XchandlesRegistryInfoFromLauncher: ...
    def __init__(self, registry: XchandlesRegistry, initialSlots: List[XchandlesHandleSlot], initialRegistrationAssetId: bytes, initialBasePrice: int) -> None: ...
    registry: XchandlesRegistry
    initial_slots: List[XchandlesHandleSlot]
    initial_registration_asset_id: bytes
    initial_base_price: int
class XchandlesTripleConditionsResult:
    def clone(self) -> XchandlesTripleConditionsResult: ...
    def __init__(self, registryConditions: List[Program], ownerConditions: List[Program], resolvedConditions: Optional[List[Program]] = None) -> None: ...
    registry_conditions: List[Program]
    owner_conditions: List[Program]
    resolved_conditions: Optional[List[Program]]
class XchandlesExtendResult:
    def clone(self) -> XchandlesExtendResult: ...
    def __init__(self, conditions: List[Program], notarizedPayment: NotarizedPayment) -> None: ...
    conditions: List[Program]
    notarized_payment: NotarizedPayment
class XchandlesExecuteUpdateResult:
    def clone(self) -> XchandlesExecuteUpdateResult: ...
    def __init__(self, registryConditions: List[Program], oldOwnerConditions: List[Program], newOwnerConditions: List[Program]) -> None: ...
    registry_conditions: List[Program]
    old_owner_conditions: List[Program]
    new_owner_conditions: List[Program]
class XchandlesRegistryActualNeighborsResult:
    def clone(self) -> XchandlesRegistryActualNeighborsResult: ...
    def __init__(self, leftSlot: XchandlesHandleSlot, rightSlot: XchandlesHandleSlot) -> None: ...
    left_slot: XchandlesHandleSlot
    right_slot: XchandlesHandleSlot
class XchandlesRegistry:
    def clone(self) -> XchandlesRegistry: ...
    def coin(self) -> Coin: ...
    def proof(self) -> Proof: ...
    def state(self) -> XchandlesRegistryState: ...
    def constants(self) -> XchandlesConstants: ...
    def inner_puzzle_hash(self) -> bytes: ...
    def puzzle_hash(self) -> bytes: ...
    def child(self) -> XchandlesRegistry: ...
    def pending_created_handle_slots(self) -> List[XchandlesHandleSlot]: ...
    def pending_created_update_slots(self) -> List[XchandlesUpdateSlot]: ...
    def pending_spent_handle_slots(self) -> List[XchandlesHandleSlotValue]: ...
    def pending_spent_update_slots(self) -> List[XchandlesUpdateSlotValue]: ...
    def pending_logs(self) -> List[XchandlesActionLog]: ...
    def pending_signature(self) -> Signature: ...
    def finish_spend(self) -> XchandlesRegistryFinishedSpendResult: ...
    def register(self, leftSlot: XchandlesHandleSlot, rightSlot: XchandlesHandleSlot, precommitCoin: XchandlesPrecommitCoin, baseHandlePrice: int, registrationPeriod: int, startTime: int, ownerInnerPuzzleHash: bytes, resolvedInnerPuzzleHash: bytes) -> XchandlesTripleConditionsResult: ...
    def refund_with_pricing(self, precommitCoin: XchandlesPrecommitCoin, pricingPuzzleReveal: Program, pricingPuzzleSolution: Program, slot: Optional[XchandlesHandleSlot] = None) -> List[Program]: ...
    def refund(self, precommitCoin: XchandlesPrecommitCoin, slot: Optional[XchandlesHandleSlot] = None) -> List[Program]: ...
    def extend(self, handle: str, slot: XchandlesHandleSlot, paymentAssetId: bytes, baseHandlePrice: int, registrationPeriod: int, numPeriods: int, buyTime: int) -> XchandlesExtendResult: ...
    def expire(self, slot: XchandlesHandleSlot, numPeriods: int, baseHandlePrice: int, registrationPeriod: int, precommitCoin: XchandlesPrecommitCoin, startTime: int, newOwnerInnerPuzzleHash: bytes, newResolvedInnerPuzzleHash: bytes) -> XchandlesTripleConditionsResult: ...
    def oracle(self, slot: XchandlesHandleSlot) -> List[Program]: ...
    def initiate_update(self, slot: XchandlesHandleSlot, newOwnerLauncherId: bytes, newResolvedLauncherId: bytes, currentOwner: CompactCoinProof, minHeight: int) -> List[Program]: ...
    def execute_update(self, handleSlot: XchandlesHandleSlot, updateSlot: XchandlesUpdateSlot, newOwnerLauncherId: bytes, newResolvedLauncherId: bytes, currentOwner: CompactCoinProof, newOwnerInnerPuzzleHash: bytes, newResolvedInnerPuzzleHash: bytes) -> XchandlesExecuteUpdateResult: ...
    def delegated_state(self, newState: XchandlesRegistryState, otherSingletonInnerPuzzleHash: bytes) -> List[Program]: ...
    def actual_neighbors(self, newHandleHash: bytes, onChainLeftSlot: XchandlesHandleSlot, onChainRightSlot: XchandlesHandleSlot) -> XchandlesRegistryActualNeighborsResult: ...
    def actual_handle_slot(self, slot: XchandlesHandleSlot) -> XchandlesHandleSlot: ...
    def actual_update_slot(self, slot: XchandlesUpdateSlot) -> XchandlesUpdateSlot: ...
    @staticmethod
    def parse_launcher_solution(launcherCoin: Coin, launcherSolution: Program) -> Optional[XchandlesRegistryInfoFromLauncher]: ...
