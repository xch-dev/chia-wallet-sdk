...
class Action:
    ...
    @staticmethod
    def mint_nft(clvm: Clvm, params: MintNftParams) -> Action: ...
    @staticmethod
    def update_nft(clvm: Clvm, id: Id, params: UpdateNftParams) -> Action: ...
    @staticmethod
    def fee(amount: int) -> Action: ...
class MintNftParams:
    def clone(self) -> MintNftParams: ...
    def __init__(self, metadata: Program, metadataUpdaterPuzzleHash: bytes, royaltyPuzzleHash: bytes, royaltyBasisPoints: int, parentDidId: Optional[Id], amount: int) -> None: ...
    metadata: Program
    metadata_updater_puzzle_hash: bytes
    royalty_puzzle_hash: bytes
    royalty_basis_points: int
    parent_did_id: Optional[Id]
    amount: int
class UpdateNftParams:
    def clone(self) -> UpdateNftParams: ...
    def __init__(self, newDataUri: Optional[str], newMetadataUri: Optional[str], newLicenseUri: Optional[str], transferDidId: Optional[Id], transferTradePrices: List[TradePrice]) -> None: ...
    new_data_uri: Optional[str]
    new_metadata_uri: Optional[str]
    new_license_uri: Optional[str]
    transfer_did_id: Optional[Id]
    transfer_trade_prices: List[TradePrice]
class Deltas:
