...
class VaultSpendReveal:
    ...
    def __init__(self, launcherId: bytes, custodyHash: bytes, delegatedSpend: Spend, coinId: Optional[bytes] = None, genesisChallenge: Optional[bytes] = None) -> None: ...
    launcher_id: bytes
    custody_hash: bytes
...
class VaultTransaction:
    ...
    def __init__(self, newCustodyHash: Optional[bytes], payments: List[ParsedPayment], nfts: List[ParsedNftTransfer], dropCoins: List[DropCoin], feePaid: int, totalFee: int, reservedFee: int, p2PuzzleHash: bytes, coinMessage: Optional[bytes], puzzleMessage: bytes) -> None: ...
    ...
    coin_message: Optional[bytes]
    puzzle_message: bytes
class ParsedPayment:
