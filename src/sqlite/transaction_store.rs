...
impl TransactionStore {
    ...
    pub async fn spent_coins(&self) -> Vec<Coin> {
        sqlx::query!(
            "
    ...
    pub async fn transactions(&self) -> Vec<Bytes32> {
    ...
    pub async fn transaction(&self, transaction_id: [u8; 32]) -> Option<SpendBundle> {
    ...
    pub async fn removals(&self, transaction_id: Bytes32) -> Vec<Coin> {
        let transaction_id = transaction_id.to_vec();
    ...
    pub async fn add_transaction(&self, spend_bundle: SpendBundle) -> bool {
    ...
    pub async fn remove_transaction(&self, transaction_id: Bytes32) -> bool {
        let transaction_id = transaction_id.to_vec();
